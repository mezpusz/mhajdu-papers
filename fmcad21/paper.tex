...
%		\IEEEauthorblockA{University of Manchester}}
	...
	% in the abstract
	\begin{abstract}
Functional programs over inductively defined data types, such as lists and nauralts,
...
generalizations to automate induction with recursive function in saturation-based first-order theorem proving.
